...
var_coupe=var(:,temps(2)+1:temps(4));
uncycle=1:(99/(temps(4)-temps(2)-1)):100;
echant=1:1:100;
...
TrialParams_N.EventsTime(3) = 100/(temps(4)-temps(2))*temps(3) + 200 - temps(4)*100/(temps(4)-temps(2));
TrialParams_N.EventsTime(4) = 200;
TrialParams_N.EventsTime(5) = 300;
TrialParams_N.EventsTime(6) = 100/(temps(7)-temps(5))*temps(6) + 400 - temps(7)*100/(temps(7)-temps(5));
